      ...
      <div class="row">
        <div class="col-6 padding30 scrollProfile45">
          ...
          <ul class="listing list-unstyled">
            <li><img src="/assets/img/1px.png" data-src="/assets/img/service-green-checkmark2.png" class="img-fluid lazyload" alt="Checkmark!"/> Work with you to determine the right size basket for your needs. </li>
            <li><img src="/assets/img/1px.png" data-src="/assets/img/service-green-checkmark2.png" class="img-fluid lazyload" alt="Checkmark!"/> Drop a basket on your wash pad and you can fill it with your parts. </li>
            <li><img src="/assets/img/service-green-checkmark2.png" class="img-fluid lazyload" alt="Checkmark!"/> Pick up that basket when it’s full or you need the cleaning done. </li>
            <li><img src="/assets/img/1px.png" data-src="/assets/img/service-green-checkmark2.png" class="img-fluid lazyload" alt="Checkmark!"/> Clean your parts for a guaranteed, fixed price. </li>
            <li><img src="/assets/img/1px.png" data-src="/assets/img/service-green-checkmark2.png" class="img-fluid lazyload" alt="Checkmark!"/> Return your basket of clean parts the next day! </li>
          </ul>
        ...
        <div class="col-6 padding30"> <img src="/assets/img/1px.png" data-src="/assets/img/BasketMontage2-min.gif?v=20201005" class="img-fluid polaroid lazyload" alt="Clean As New® offers a Basket Rental and Bulk Parts Cleaning Service." /> </div>
      </div>
    </div>
  </div>
</main>

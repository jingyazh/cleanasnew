...
@section('title')
<title>Why Partner with Clean As New®</title>
@endsection
  ...
  <div class="jumbotron text-left">
    <div class="headline" itemscope itemtype="http://schema.org/BreadcrumbList"> &nbsp;
      <p> <span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"> <a href="how-we-compare" itemprop="item"> <span itemprop="name">{{__("How We Compare")}}</span></a>
        ...
        </span> &#8250; <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"> <span itemprop="name">{{__("Facility")}}</span>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-8 padding30 text-center"> <br>
          <h2 class="text-center h1">Why Partner with <span class="cangc">C</span><span class="cangc2">LEAN</span> <span class="cangc">A</span><span class="cangc2">S</span> <span class="cangc">N</span><span class="cangc2">EW</span><sup class="suplarge">®</sup>?</h2>
          ...
          <h2 class="text-center"><i>Why not do an Apple-to-Apple comparison?</i></h2>
          <p> <img src="https://cleanasnew.com/assets/img/1px.png" data-src="https://cleanasnew.com/assets/img/comparison-cost.jpg?v=20200921" class="img-fluid lazyload"  alt="Wash Pad Hydroblasting VS. Clean As New Powered By Tech Sonic®."/> </p>
          <div class="col-9 mt-5 ml-lg-5 mb-5 text-left">
            <h3>Facility</h3>

...
<main>
  <div class="jumbotron text-left">
      ...
      <p><span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="/" itemprop="item"><span itemprop="name">{{__("Home")}}</span></a>   <meta itemprop="position" content="1"></span> &#8250; <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">{{__("Still Just Hydroblasting Your Exchangers?")}}</span><meta itemprop="position" content="2"></span> </p>
    </div>
  </div>

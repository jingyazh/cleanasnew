...
- Offsite Cleaning Facilities</h5>
                  <ul class="list-group  list-group-flush text-muted contactListing">
                    <li class="list-group-item"> 1303 Thompson Park Drive</li>
                    <li class="list-group-item"> Baytown, Texas 77521 USA </li>
                    <li class="list-group-item">T: +1.832.271.2666 </li>
                    <li class="list-group-item">E: <a href="mailto:info@cleanasnew.com">info@cleanasnew.com</a> </li>
                  </ul>
					 <br>                 <h5 class="card-title"><span class="cangc">C</span><span class="cangc2">LEAN</span> <span class="cangc">A</span><span class="cangc2">S</span> <span class="cangc">N</span><span class="cangc2">EW</span><sup>®</sup>
 - Offices </h5>
                  <ul class="list-group list-group-flush text-muted contactListing">
                    <li class="list-group-item">6314 Hgwy 73</li>
                    <li class="list-group-item"> Geismar, Louisiana 70734 USA </li>
                    <li class="list-group-item">T: +1.225.407.0666 </li>
                    <li class="list-group-item">E: <a href="mailto:info@cleanasnew.com">info@cleanasnew.com</a> </li>
                  </ul>
                  <p><br>

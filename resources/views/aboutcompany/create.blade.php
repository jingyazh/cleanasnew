...
<h1 class="m-0 text-dark">{{__('Add Company Information')}}</h1>
@stop
...
<div class="row">
  <div class="col-12">
    ...
    @endif
    <form method="POST" action="{{ route('aboutcompany.store') }}" id="frmCreateClient" enctype="multipart/form-data">
      @csrf
      <input type="hidden" id="isautoplaceorder" name="isautoplaceorder" value="0" />
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">{{__('Add Company Information')}} </h3>
        ...
        <div class="card-body">
          ...
          <div class="form-group col-md-12">
            ...
            <small id="passwordHelpBlock" class="ul-form__text form-text ">
              View example <a href="/assets/examples/aboutcompany.jpg" target="_blank">here</a>
            </small>
          </div>

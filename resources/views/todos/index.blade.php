...
<div style="justify-content: space-between; display: flex">
  <h1 class="m-0 text-dark">{{__('How We Do It')}}</h1>
        ...
        <div class="card-body">
          <div class="form-group col-md-12">
            ...
            <div style="display: flex; flex-direction: row">
              <input type="text" name="todos_meta_title" class="form-control col-sm-12" value="{{isset($metadata) ? $metadata->todos_meta_title : ''}}" required placeholder="{{__('Meta Title')}}" />
            </div>
          </div>
          ...
          <div class="form-group col-md-12">
            ...
            <div style="display: flex; flex-direction: row">
              <input type="text" name="todos_meta_description" class="form-control col-sm-12" value="{{isset($metadata) ? $metadata->todos_meta_description : ''}}" required placeholder="{{__('Meta Description')}}" />
            </div>
          </div>
        </div>
        <!-- /.card-body -->
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="{!! route('todos.create') !!}" class="btn btn-tool">{{__('Add')}} &nbsp; <i class="fa fa-plus"></i></a>
        </div>
...
<script>
  ...
  $(function() {
    ...
    oTable = $("#listtable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "{{ route('todos.data', ['locale' => str_replace('_', '-', app()->getLocale())]) }}",

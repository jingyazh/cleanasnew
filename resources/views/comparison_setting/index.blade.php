        ...
        <div class="form-group col-md-12">
          ...
          <div class="form-group col-md-12">
            ...
            <div style="display: flex; flex-direction: row">
              <input type="text" name="comparison_meta_title" class="form-control col-sm-12" value="{{isset($metadata) ? $metadata->comparison_meta_title : ''}}" required placeholder="{{__('Meta Title')}}" />
            </div>
          </div>
          ...
          <div class="form-group col-md-12">
            ...
            <div style="display: flex; flex-direction: row">
              <input type="text" name="comparison_meta_description" class="form-control col-sm-12" value="{{isset($metadata) ? $metadata->comparison_meta_description : ''}}" required placeholder="{{__('Meta Description')}}" />
            </div>
          </div>
        </div>
        <!-- /.card-body -->

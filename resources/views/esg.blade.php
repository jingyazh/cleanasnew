  ...
  <div class="album bg-light">
    <div class="container">
      <div class="row"> <a href="esg/how-better-cleaning-can-help">
        ...
        <div class="accordion md-accordion mobileNone" id="accordionEx" role="tablist" >
          <div class="card">
          ...
          <div class="card">
            ...
            <div id="collapseOne{{$key+1}}" class="collapse {{$key==0 ? 'show' : ''}}" role="tabpanel" aria-labelledby="headingOne{{$key+1}}" data-parent="#accordionEx">
              <div class="card-body">
                <div class="col-md-12 row" style="margin-right: 15px; margin-left: 15px;max-width:98vw">
                  {!! $value->embed !!}
                </div>
              </div>
            </div>

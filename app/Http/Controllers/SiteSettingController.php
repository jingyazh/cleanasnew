...
class SiteSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image1 = $request->file('home_esg_image')->getClientOriginalName();
        ...
        $image2 = $request->file('comparison_image')->getClientOriginalName();
        ...
        $image3 = $request->file('service_image')->getClientOriginalName();
        ...
        $image4 = $request->file('service_list_image')->getClientOriginalName();
